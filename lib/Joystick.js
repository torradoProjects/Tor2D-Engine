import {TextureButton} from "./Import.js";
import { currentScene, uiCanvas, uiCtx } from "./Variables.js";
export class Joystick extends TextureButton 
{
    constructor(name, pos, size, texture_outer, texture_inner, maxDistance = 50) 
    {
        super(name, pos, size, texture_outer, texture_outer);
